...
missioniApp.controller('AnnullamentoOrdineMissioneController', function($rootScope, $scope, $routeParams, $sessionStorage, AnnullamentoOrdineMissioneService, OrdineMissioneService,
        ...
        if ($scope.annullamentoModel.ordineMissione.esercizioOriginaleObbligazione && $scope.annullamentoModel.ordineMissione.pgObbligazione) {
            ...
            if ($scope.gaeSelected) {
                ...
                varClauses = [{
                        ...
                        fieldName: 'esercizio',
                        operator: "=",
                        fieldValue: $scope.annullamentoModel.ordineMissione.anno
                    },
                    {
                        condition: 'AND',
                        fieldName: 'cdCds',
                        operator: "=",
                        fieldValue: $scope.annullamentoModel.ordineMissione.cdsSpesa
                    },
                    {
                        condition: 'AND',
                        fieldName: 'esercizioOriginale',
                        operator: "=",
                        fieldValue: $scope.annullamentoModel.ordineMissione.esercizioOriginaleObbligazione
                    },
                    {
                        condition: 'AND',
                        fieldName: 'pgObbligazione',
                        operator: "=",
                        fieldValue: $scope.annullamentoModel.ordineMissione.pgObbligazione
                    },
                    {
                        condition: 'AND',
                        fieldName: 'cdLineaAttivita',
                        operator: "=",
                        fieldValue: $scope.annullamentoModel.ordineMissione.gaeSelected
                    }
                ];
            } else {
        ...
        if ($scope.esisteAnnullamento && ($scope.annullamentoModel.stato === 'DEF' ||
                ...
                ($scope.annullamentoModel.stato === 'CON' &&
                    ($scope.annullamentoModel.statoFlusso === 'INV' ||
                        $scope.annullamentoModel.statoFlusso === 'FPF' ||
                        $scope.annullamentoModel.statoFlusso === 'APP')))) {
            return true;
        } else {
            return false;
        }
    ...
    var deleteAnnullamentoOrdineMissione = function() {
        $rootScope.salvataggio = true;
        AnnullamentoOrdineMissioneService.delete({
                ids: $scope.annullamentoModel.id
            },
            function(responseHeaders) {
                $rootScope.salvataggio = false;
    ...
    $scope.doPrintAnnullamentoOrdineMissione = function(idAnnullamentoOrdineMissione) {
        ...
        $http.get('api/rest/annullamentoOrdineMissione/print/json', {
                params: {
                    idMissione: idAnnullamentoOrdineMissione
                }
            })
            .success(function(data) {
