...
//            caricaCdsCompetenza(cds, data.elements);
    ...
    if (uo) {
        ...
        if (pgProgetto) {
            varClauses = [
                { condition: 'AND', fieldName: 'livello', operator: "=", fieldValue: 2 },
                ...
                { condition: 'AND', fieldName: 'pg_progetto', operator: "=", fieldValue: pgProgetto }
            ];
        } else {
            varClauses = [
                { condition: 'AND', fieldName: 'livello', operator: "=", fieldValue: 2 },
            ...
            $http.post(urlRestProxy + app + '/', postModuli, { params: { proxyURL: url } })
