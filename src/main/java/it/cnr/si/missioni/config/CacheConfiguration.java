...
import it.cnr.si.config.MetricsConfiguration;
...
public class CacheConfiguration {
    ...
    private final Logger log = LoggerFactory.getLogger(it.cnr.si.config.CacheConfiguration.class);
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) throws UnknownHostException {
        ...
        config.getGroupConfig().setName("sprint-formazione");
        config.getGroupConfig().setPassword("sprint-formazione-pass");
