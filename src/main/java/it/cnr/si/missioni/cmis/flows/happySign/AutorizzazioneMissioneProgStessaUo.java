...
@ConditionalOnExpression(
        "!T(org.springframework.util.StringUtils).isEmpty('${flows.autorizzazione.progstessauo:}')"
)
public class AutorizzazioneMissioneProgStessaUo extends FlussiToHappySignService implements AutorizzazioneMissione{
