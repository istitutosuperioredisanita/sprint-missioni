...
public class DateUtils {
    ...
    /**
     * @param aDate - Una data (ovvero la rappresentazione in String di una data)
     ...
     *
     * @param data    data da formattare secondo il pattern passato
     * @param pattern pattern da utilizzare per il formato della data
     ...
     *
     * @param calendar     data che si deve impostare.
     * @param ore          .
     * @param minuti       .
     * @param secondi      .
     * @param millisecondi .
     ...
     *
     * @param date             data che deve essere incrementata in numero di mesi.
     * @param mesiDaAggiungere numero di mesi da aggiungere alla data.
     ...
     * alla data <i>date</i>.
     *
     * @param date               data che deve essere incrementata in numero di giorni.
     * @param giorniDaAggiungere numero di giorni da aggiungere alla data.
     ...
     *
     * @param anno anno da controllare
     ...
     * @param data2 data da ritornare se data1 è null
     ...
     *
     * @param dataIn data da controllare (nel formato stringa)
     * @return <i>anno</i> dellea data
     * @throws AwesomeException solleva eccezione se la stringa rappresentante la data non è
     *                          nel forato giusto
     */
    public static Short calcolaAnnoDaData(String dataIn) throws AwesomeException {
        ...
        return Short.valueOf((short) calcolaAnnoDaData(parseDate(dataIn, DateUtils.PATTERN_DATE)));
    }

    /**
     * Metodo che ritorna l'anno dalla <i>dataIn</i> passata in ingresso.
     *
     * @param dataIn data da controllare
     ...
     *
     * @param meseN mese da convertire nel formato stringa.
     * @return <i>meseS</i> del mese
     * @throws AwesomeException solleva eccezione se il valore del mese non è
     *                          <p>
