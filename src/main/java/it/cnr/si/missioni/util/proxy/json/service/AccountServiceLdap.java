...
public class AccountServiceLdap extends AbstractAccountService{
    ...
    public Account loadAccount(Boolean loadSpecialUserData) {
        ...
        if (userInfo.isPresent()) {
            ...
            if (userInfoDto != null && userInfoDto.getCognome() != null) {
                return getAccountFromUser(loadSpecialUserData, userInfoDto);
            } else {
                return getAccountWithoutRole();
            }
        }
        return null;
    }

    private Account getAccountFromUser(Boolean loadSpecialUserData, UserInfoDto userInfoDto) {
    ...
    public String getAccount(Boolean loadSpecialUserData) {
        ...
        if (userInfo.isPresent()) {
            ...
            if (userInfoDto != null && userInfoDto.getCognome() != null) {
                ...
                Account account = getAccountFromUser(loadSpecialUserData, userInfoDto);
    ...
    protected Account getAccountWithoutRole() {
