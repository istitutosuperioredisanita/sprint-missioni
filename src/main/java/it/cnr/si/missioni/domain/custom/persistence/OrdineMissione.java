...
public class OrdineMissione extends OggettoBulkXmlTransient implements Serializable {
	...
	public final static String CMIS_PROPERTY_MAIN = "F:missioni:main",
			CMIS_PROPERTY_NAME_ANNO = "missioni:anno",
			CMIS_PROPERTY_NAME_NUMERO = "missioni:numero",
			CMIS_PROPERTY_NAME_ID = "missioni:id",
			CMIS_PROPERTY_NAME_UID = "missioni:uid",
			CMIS_PROPERTY_NAME_MODULO = "missioni:modulo",
			CMIS_PROPERTY_NAME_OGGETTO = "missioni:oggetto",
			CMIS_PROPERTY_NAME_DESTINAZIONE = "missioni:destinazione",
			CMIS_PROPERTY_NAME_NOTE = "missioni:note",
			CMIS_PROPERTY_NAME_DATA_INIZIO = "missioni:dataInizio",
			CMIS_PROPERTY_NAME_DATA_FINE = "missioni:dataFine",
			CMIS_PROPERTY_NAME_DATA_INSERIMENTO = "missioni:dataInserimento",
			...
			CMIS_PROPERTY_AUTO_PROPRIA_PRIMO_MOTIVO = "cnrmissioni:autoPropriaPrimoMotivo",
			CMIS_PROPERTY_AUTO_PROPRIA_SECONDO_MOTIVO = "cnrmissioni:autoPropriaSecondoMotivo",
			CMIS_PROPERTY_AUTO_PROPRIA_TERZO_MOTIVO = "cnrmissioni:autoPropriaTerzoMotivo",
			...
			CMIS_PROPERTY_FLOW_TRATTAMENTO	= "cnrmissioni:trattamento",
